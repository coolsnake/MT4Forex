...
{
public:
    MT4AuthCluster(int num, const std::string &pu_key, const std::string &pr_key, const std::string& host, const std::string& username, const std::string& password, const std::string& database);
    ~MT4AuthCluster();
